	...
	public function testHelperCallbackTriggering() {
		...
		$View->Helpers->expects($this->at(0))->method('trigger')
			->with(
				$this->logicalAnd(
					...
					$this->callback(fn(CakeEvent $event) => $event->name() === 'View.beforeRender'),
					$this->callback(fn(CakeEvent $event) => $event->subject() === $View),
				)
			);
		$View->Helpers->expects($this->at(1))->method('trigger')
			->with(
				$this->logicalAnd(
					$this->isInstanceOf('CakeEvent'),
					$this->callback(fn(CakeEvent $event) => $event->name() === 'View.beforeRenderFile'),
					$this->callback(fn(CakeEvent $event) => $event->subject() === $View),
				)
			);
		...
		$View->Helpers->expects($this->at(2))->method('trigger')
			->with(
				$this->logicalAnd(
					$this->isInstanceOf('CakeEvent'),
					$this->callback(fn(CakeEvent $event) => $event->name() === 'View.afterRenderFile'),
					$this->callback(fn(CakeEvent $event) => $event->subject() === $View),
				)
			);
		$View->Helpers->expects($this->at(3))->method('trigger')
			->with(
				$this->logicalAnd(
					$this->isInstanceOf('CakeEvent'),
					$this->callback(fn(CakeEvent $event) => $event->name() === 'View.afterRender'),
					$this->callback(fn(CakeEvent $event) => $event->subject() === $View),
				)
			);
		...
		$View->Helpers->expects($this->at(4))->method('trigger')
			->with(
				$this->logicalAnd(
					$this->isInstanceOf('CakeEvent'),
					$this->callback(fn(CakeEvent $event) => $event->name() === 'View.beforeLayout'),
					$this->callback(fn(CakeEvent $event) => $event->subject() === $View),
				)
			);
		...
		$View->Helpers->expects($this->at(7))->method('trigger')
			->with(
				$this->logicalAnd(
					$this->isInstanceOf('CakeEvent'),
					$this->callback(fn(CakeEvent $event) => $event->name() === 'View.afterLayout'),
					$this->callback(fn(CakeEvent $event) => $event->subject() === $View),
				)
			);
